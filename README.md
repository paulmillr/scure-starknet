...
The package is 2.3x (signVerify) to 13.3x (pedersen) faster than `@starkware-industries/starkware-crypto-utils`.

```
Benchmarking
==== pedersenHash ====
pedersenHash (starkware) x 84 ops/sec @ 11ms/op
pedersenHash (micro-starknet) x 1,123 ops/sec @ 890μs/op

==== signVerify ====
signVerify (starkware) x 299 ops/sec @ 3ms/op
signVerify (micro-starknet) x 697 ops/sec @ 1ms/op

RAM: rss=86.9mb heap=31.7mb used=19.6mb ext=0.6mb
```

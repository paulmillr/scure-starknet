...
const parsed = {
  poseidon3: parseTest('./test/poseidon/poseidon3.txt'),
  poseidon4: parseTest('./test/poseidon/poseidon4.txt'),
  poseidon5: parseTest('./test/poseidon/poseidon5.txt'),
  poseidon9: parseTest('./test/poseidon/poseidon9.txt'),
};
